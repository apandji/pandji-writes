...
2) I then set up the @font-face as normal. Because it was out of the npm thing I was familiar with doing this
...
For my self directed experiment, I used my buddy AI to teach me about npm. I have used this in the past but never really did commands manually. Things that I learned from this experiment - for the Geist font I used npm like a delivery truck. It loaded in the font files, I moved it to its own folder. This means that I can delete all the extra files which I did through 'npm uninstall'. I also learned how to see all the things I brought in from the delivery truck by using `npm ls`. I ran out of time but there's more to learn. One thing though here, is my AI definitely hallucinated, and thought there was no /fonts folder. I got mad at it.

# experiment four - teach me something new

For my last experiment I asked my AI buddy to teach me something trending. A library, or something cool. There's a web dev podcast called Syntax I listen to. What the AI buddy suggestsd was this thing called Motion. So I installed it using npm install (what I learned from 3). What I learned from this experiment - how to have my index.html reference a script file, I created a main.js file. That file did the following, import the animation library. Then wiring my hero to animate was actually pretty simple.
